...
const DashboardPage: React.FC<DashboardPageProps> = ({ onLogout }) => {
  const { orders, orderCount, loading, error, fetchOrders, updateOrderStatus } = useOrders();
          ...
          <div className="p-6 bg-white rounded-lg shadow">
              <div className="flex items-center gap-4">
                  ...
                  <div>
                      ...
                      <p className="text-2xl font-semibold text-gray-900">{loading && orderCount === 0 ? '...' : orderCount}</p>
                  </div>
              </div>
          </div>
          <div className="p-6 bg-white rounded-lg shadow">
